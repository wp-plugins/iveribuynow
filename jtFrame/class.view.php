...
*/
 class jtView {
 	...
 	*/
 	public function __construct($admin=false, $model=false){
	...
	public function addDefaultScript($script, $src=false, $plugin_specific=false){
		$src = ($plugin_specific && $src) ? $this->tmplUrl . "js/" . $src : $src;
		wp_enqueue_script($script, $src, array(), false, $plugin_specific);
	}
	
	public function addDefaultStyle($style, $src=false, $plugin_path=false){
		$src = ($plugin_path && $src) ? $this->tmplUrl . "css/" . $src : $src;		
